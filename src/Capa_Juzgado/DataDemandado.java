...
public class DataDemandado {
    ...
    public String BuscarDemandd() {
        Conexion objBusc = new Conexion();
        String cad="Select * from Demandado where ID_demandado ='"+ this.getDemdd_ID()+"'";
        return objBusc.Ejecutar(cad);  
    }
