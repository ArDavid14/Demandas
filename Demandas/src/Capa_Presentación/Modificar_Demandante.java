...
public class Modificar_Demandante extends javax.swing.JPanel {
    ...
    public void ListarDemandante()
    {
        ...
        for (DataDemandante x: lista2) 
        {
            ...
            tabla.setValueAt(x.getDemdt_Apel(), i, 2);
            tabla.setValueAt(x.getDemdt_TipoID(), i,3);
            tabla.setValueAt(x.getDemdt_Correo(), i, 4);
            tabla.setValueAt(x.getDemdt_Direc(), i, 5);
            tabla.setValueAt(x.getDemdt_Telef(), i, 6);
            i++;
        }
