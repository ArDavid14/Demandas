...
public class DataApoderadoDemdt {
    ...
    public String GuardarApoDemandante(){
        ...
        String cad = "insert into apoderado_demandante values('"+this.getApoDemdt_ID()+"','"+this.getApoDemdt_Nom()+
                "','"+this.getApoDemdt_Apel()+"','"+this.getApoDemdt_TipoID()+
    ...
    public String ModificarApoDemandt(){
        ...
        String cad ="update apoderado_demandante set nombre ='"+this.getApoDemdt_Nom()
                +"', Apellido='"+this.getApoDemdt_Apel()+"', Tipo_id='"+this.getApoDemdt_TipoID()
    ...
    public ArrayList<DataApoderadoDemdt> ListaApoDemdt()
    {
        ...
        try {
            ...
            while (tabla2.next()) {
                ...
                objADemdt.setApoDemdt_ID(tabla2.getInt("Id_Apdemandante"));
                objADemdt.setApoDemdt_Nom(tabla2.getString("Nombre"));
                objADemdt.setApoDemdt_Apel(tabla2.getString("Apellido"));
                ...
                objADemdt.setApoDemdt_Telef(tabla2.getInt("Telefono"));
    ...
    public int getApoDemdt_ID() {
        return ApoDemdt_ID;
    }

    public void setApoDemdt_ID(int ApoDemdt_ID) {
    ...
    public String getApoDemdt_Apel() {
        return ApoDemdt_Apel;
    }

    public void setApoDemdt_Apel(String ApoDemdt_Apel) {
        this.ApoDemdt_Apel = ApoDemdt_Apel;
    }
    ...
    public int getApoDemdt_Telef() {
        return ApoDemdt_Telef;
    }

    public void setApoDemdt_Telef(int ApoDemdt_Telef) {
