...
public class DataApoderadoDemdd {
    ...
    public String GuardarApoDemandado(){
        ...
        String cad = "insert into apoderado_demandado values('"+this.getApoDemdd_ID()+"','"+this.getApoDemdd_Nom()+
                "','"+this.getApoDemdd_Apel()+"','"+this.getApoDemdd_TipoID()+
    ...
    public String ModificarApoDemandd(){
        ...
        String cad ="update apoderado_demandado set nombre ='"+this.getApoDemdd_Nom()
                +"', Apellido='"+this.getApoDemdd_Apel()+"', Tipo_id='"+this.getApoDemdd_TipoID()
    ...
    public ArrayList<DataApoderadoDemdd> ListaApodeDemdd()
    {
        ...
        try {
            ...
            while (tabla2.next()) {
                ...
                objADemdd.setApoDemdd_ID(tabla2.getInt("Id_Apdemandado"));
                objADemdd.setApoDemdd_Nom(tabla2.getString("Nombre"));
                objADemdd.setApoDemdd_Apel(tabla2.getString("Apellido"));
                ...
                objADemdd.setApoDemdd_Telef(tabla2.getInt("Telefono"));
    ...
    public int getApoDemdd_ID() {
        return ApoDemdd_ID;
    }

    public void setApoDemdd_ID(int ApoDemdd_ID) {
    ...
    public String getApoDemdd_Apel() {
        return ApoDemdd_Apel;
    }

    public void setApoDemdd_Apel(String ApoDemdd_Apel) {
        this.ApoDemdd_Apel = ApoDemdd_Apel;
    }
    ...
    public int getApoDemdd_Telef() {
        return ApoDemdd_Telef;
    }

    public void setApoDemdd_Telef(int ApoDemdd_Telef) {
