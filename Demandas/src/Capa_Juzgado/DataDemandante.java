...
public class DataDemandante {
    ...
    public String GuardarDemandante(){
        ...
        String cad = "insert into demandante values('"+this.getDemt_ID()+"','"+this.getDemdt_Nom()+
                "','"+this.getDemdt_Apel()+"','"+this.getDemdt_TipoID()+
    ...
    public String ModificarDemandt(){
        ...
        String cad ="update Demandante set nombre ='"+this.getDemdt_Nom()
                +"', Apellido='"+this.getDemdt_Apel()+"', Tipo_id='"+this.getDemdt_TipoID()
    ...
    public ArrayList<DataDemandante> ListaDemandante()
    {
        ...
        try {
            ...
            while (tabla.next()) {
                ...
                objDemdt.setDemdt_Apel(tabla.getString("Apellido"));
    ...
    public String getDemdt_Apel() {
        return Demdt_Apel;
    }

    public void setDemdt_Apel(String Demdt_Apel) {
        this.Demdt_Apel = Demdt_Apel;
    }
